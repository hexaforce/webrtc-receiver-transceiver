...
function e(e, t, n) {
  ...
  'function' == typeof a ? (a = new a(t, { detail: n })) : ((a = r.createEvent('Event')).initEvent(t, !1, !1), (a.detail = n)), e.dispatchEvent(a)
}
function t(e) {
...
class Inspector {
  ...
  rejected(t, n) {
    ...
    ;(o.className = 'observablehq--inspect'), n && o.appendChild(r(n)), o.appendChild(document.createTextNode((t + '').replace(se, ''))), a.appendChild(o), e(a, 'error', { error: t })
  }
}
...
function ot(e) {
  const t = {}
  for (const n of e) for (const e in n) Ke.call(n, e) && (null == n[e] ? Object.defineProperty(t, e, { get: it(n, e) }) : (t[e] = n[e]))
  return t
}
function it(e, t) {
  return () => e[t]
...
class SQLiteDatabaseClient {
  ...
  async explain(e, t) {
    return ht('pre', { className: 'observablehq--inspect' }, [bt((await this.query(`EXPLAIN QUERY PLAN ${e}`, t)).map((e) => e.detail).join('\n'))])
  }
...
class DuckDBClient {
  ...
  async describeColumns({ table: e } = {}) {
    return (await this.query(`DESCRIBE ${this.escape(e)}`)).map(({ column_name: e, column_type: t, null: n }) => ({ name: e, type: At(t), nullable: 'NO' !== n, databaseType: t }))
  }
  static async of(e = {}, t = {}) {
      ...
      void 0 === ut &&
        (ut = (async function () {
          const e = await import(`${lt}${Ve.resolve()}`),
            t = await e.selectBundle({ mvp: { mainModule: `${lt}${Ve.resolve('dist/duckdb-mvp.wasm')}`, mainWorker: `${lt}${Ve.resolve('dist/duckdb-browser-mvp.worker.js')}` }, eh: { mainModule: `${lt}${Ve.resolve('dist/duckdb-eh.wasm')}`, mainWorker: `${lt}${Ve.resolve('dist/duckdb-browser-eh.worker.js')}` } }),
...
const It = Object.assign(
  async (e, t, n, r) => {
    if (((e = await Rt(await e, r)), (a = e) && ('function' == typeof a.sql || ('function' == typeof a.queryTag && ('function' == typeof a.query || 'function' == typeof a.queryStream))) && ('table' !== o || 'function' == typeof a.describeColumns) && a !== It))
      return Ft(
        e,
        (function (e, t) {
...
function mn(
  ...
  const n = [],
    r = e.slice(0, 100)
  for (const e of t) {
    const t = { boolean: 0, integer: 0, number: 0, date: 0, string: 0, array: 0, object: 0, bigint: 0, buffer: 0, defined: 0 }
    for (const n of r) {
      let r = n[e]
      if (null == r) continue
      const a = typeof r
...
var Cn = { math: 'http://www.w3.org/1998/Math/MathML', svg: 'http://www.w3.org/2000/svg', xhtml: 'http://www.w3.org/1999/xhtml', xlink: 'http://www.w3.org/1999/xlink', xml: 'http://www.w3.org/XML/1998/namespace', xmlns: 'http://www.w3.org/2000/xmlns/' }
var Nn = 0
function xn(e) {
...
function Sn(e, t) {
  ...
  return { [Symbol.iterator]: $n, next: () => (n ? { done: !0 } : ((n = !0), { done: !1, value: e })), return: () => ((n = !0), t(e), { done: !0 }), throw: () => ({ done: (n = !0) }) }
}
function qn(e) {
  let t,
    n,
    ...
    function (e) {
      ...
      Object.defineProperties(
        ...
        ((n = {
          ...
          aapl: () => new FileAttachment('https://static.observableusercontent.com/files/3ccff97fd2d93da734e76829b2b066eafdaac6a1fafdec0faf6ebc443271cfc109d29e80dd217468fcb2aff1e6bffdc73f356cc48feb657f35378e6abbbb63b9').csv({ typed: !0 }),
          alphabet: () => new FileAttachment('https://static.observableusercontent.com/files/75d52e6c3130b1cae83cda89305e17b50f33e7420ef205587a135e8562bcfd22e483cf4fa2fb5df6dff66f9c5d19740be1cfaf47406286e2eb6574b49ffc685d').csv({ typed: !0 }),
          cars: () => new FileAttachment('https://static.observableusercontent.com/files/048ec3dfd528110c0665dfa363dd28bc516ffb7247231f3ab25005036717f5c4c232a5efc7bb74bc03037155cb72b1abe85a33d86eb9f1a336196030443be4f6').csv({ typed: !0 }),
          citywages: () => new FileAttachment('https://static.observableusercontent.com/files/39837ec5121fcc163131dbc2fe8c1a2e0b3423a5d1e96b5ce371e2ac2e20a290d78b71a4fb08b9fa6a0107776e17fb78af313b8ea70f4cc6648fad68ddf06f7a').csv({ typed: !0 }),
          diamonds: () => new FileAttachment('https://static.observableusercontent.com/files/87942b1f5d061a21fa4bb8f2162db44e3ef0f7391301f867ab5ba718b225a63091af20675f0bfe7f922db097b217b377135203a7eab34651e21a8d09f4e37252').csv({ typed: !0 }),
          flare: () => new FileAttachment('https://static.observableusercontent.com/files/a6b0d94a7f5828fd133765a934f4c9746d2010e2f342d335923991f31b14120de96b5cb4f160d509d8dc627f0107d7f5b5070d2516f01e4c862b5b4867533000').csv({ typed: !0 }),
          industries: () => new FileAttachment('https://static.observableusercontent.com/files/76f13741128340cc88798c0a0b7fa5a2df8370f57554000774ab8ee9ae785ffa2903010cad670d4939af3e9c17e5e18e7e05ed2b38b848ac2fc1a0066aa0005f').csv({ typed: !0 }),
          ...
          olympians: () => new FileAttachment('https://static.observableusercontent.com/files/31ca24545a0603dce099d10ee89ee5ae72d29fa55e8fc7c9ffb5ded87ac83060d80f1d9e21f4ae8eb04c1e8940b7287d179fe8060d887fb1f055f430e210007c').csv({ typed: !0 }),
          penguins: () => new FileAttachment('https://static.observableusercontent.com/files/715db1223e067f00500780077febc6cebbdd90c151d3d78317c802732252052ab0e367039872ab9c77d6ef99e5f55a0724b35ddc898a1c99cb14c31a379af80a').csv({ typed: !0 }),
          pizza: () => new FileAttachment('https://static.observableusercontent.com/files/c653108ab176088cacbb338eaf2344c4f5781681702bd6afb55697a3f91b511c6686ff469f3e3a27c75400001a2334dbd39a4499fe46b50a8b3c278b7d2f7fb5').csv({ typed: !0 }),
          weather: () => new FileAttachment('https://static.observableusercontent.com/files/693a46b22b33db0f042728700e0c73e836fa13d55446df89120682d55339c6db7cc9e574d3d73f24ecc9bc7eb9ac9a1e7e104a1ee52c00aab1e77eb102913c1f').csv({ typed: !0 }),
          DOM: An,
          Files: jn,
          Generators: Ln,
          Promises: Dn,
...
function Module(e, t = []) {
  Object.defineProperties(this, { _runtime: { value: e }, _scope: { value: new Map() }, _builtins: { value: new Map([['@variable', or], ['invalidation', ir], ['visibility', sr], ...t]) }, _source: { value: null, writable: !0 } })
}
...
function Runtime(e = new Library(), t = yr) {
  const n = this.module()
  if ((Object.defineProperties(this, { _dirty: { value: new Set() }, _updates: { value: new Set() }, _precomputes: { value: [], writable: !0 }, _computing: { value: null, writable: !0 }, _init: { value: null, writable: !0 }, _modules: { value: new Map() }, _variables: { value: new Set() }, _disposed: { value: !1, writable: !0 }, _builtin: { value: n }, _global: { value: t } }), e)) for (const t in e) new Variable(2, n).define(t, [], e[t])
}
function fr(e) {
...
function br(e, t) {
  let n,
    ...
    s = Jn
  return (
    a && ((r = new IntersectionObserver(([e]) => (o = e.isIntersecting) && ((n = null), i()))), r.observe(a), e.then(() => (r.disconnect(), (r = null), s()))),
    function (e) {
    ...
    if (
      ...
      return (
        ...
        (function (e, t, n) {
          ...
          let a
          function o(e) {
            return new Promise((e) => e(n.next(a))).then(({ done: t, value: n }) => (t ? void 0 : Promise.resolve(n).then(e)))
          }
          function i() {
            const n = o((o) => {
