...
function _15(Scrubber) {
  return Scrubber(['red', 'green', 'blue'], { delay: 1000 })
}

function _loopDelay(md) {
  return md`
The _loopDelay_ option, which defaults to 0, specifies how long to wait before looping in milliseconds. This can be paired with the _initial_ option to show the ending value before the animation starts anew from the beginning.
  `
}
