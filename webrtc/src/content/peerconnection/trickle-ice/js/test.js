...
describe('Trickle-Ice', () => {
  ...
  it('adding a server', async () => {
    await driver.findElement(webdriver.By.id('url')).sendKeys('stun:stun.l.google.com:19302')
    await driver.findElement(webdriver.By.id('add')).click()
    const length = await driver.findElement(webdriver.By.css('#servers')).getAttribute('length')
