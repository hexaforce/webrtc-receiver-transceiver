...
describe('peerconnection ice restart', () => {
  ...
  it('establishes a connection and changes candidates on restart', async () => {
    ...
    const firstCandidateIds = await Promise.all([await driver.findElement(webdriver.By.id('localCandidateId')).getAttribute('innerText'), await driver.findElement(webdriver.By.id('remoteCandidateId')).getAttribute('innerText')])
    ...
    const secondCandidateIds = await Promise.all([await driver.findElement(webdriver.By.id('localCandidateId')).getAttribute('innerText'), await driver.findElement(webdriver.By.id('remoteCandidateId')).getAttribute('innerText')])
