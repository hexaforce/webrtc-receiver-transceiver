...
minWidthInput.onchange = maxWidthInput.onchange = minHeightInput.onchange = maxHeightInput.onchange = minFramerateInput.onchange = maxFramerateInput.onchange = displayRangeValue
...
function hangup() {
  ...
  Promise.all([remotePeerConnection.getStats(null).then(showRemoteStats, (err) => console.log(err)), localPeerConnection.getStats(null).then(showLocalStats, (err) => console.log(err))]).then(() => {
...
setInterval(() => {
  ...
  if (localPeerConnection && remotePeerConnection) {
    remotePeerConnection.getStats(null).then(showRemoteStats, (err) => console.log(err))
    localPeerConnection.getStats(null).then(showLocalStats, (err) => console.log(err))
  } else {
