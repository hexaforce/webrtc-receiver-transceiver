...
class Pipeline {
  ...
  async updateSource(mediaStreamSource) {
    ...
    console.log('[Pipeline] Updated source.', 'debug.pipeline.source_ = ', this.source_)
  ...
  async maybeStartPipeline_() {
    ...
    console.log('[Pipeline] Pipeline started.', 'debug.pipeline.abortController_ =', this.abortController_)
  }
  ...
  async updateTransform(frameTransform) {
    ...
    console.log('[Pipeline] Updated frame transform.', 'debug.pipeline.frameTransform_ = ', this.frameTransform_)
  ...
  async updateSink(mediaStreamSink) {
    ...
    console.log('[Pipeline] Updated sink.', 'debug.pipeline.sink_ = ', this.sink_)
    if (this.processedStream_) {
      await this.sink_.setMediaStream(this.processedStream_)
    } else {
      await this.maybeStartPipeline_()
