...
class VideoSource {
  ...
  updateVideoVisibility() {
    if (this.video_.parentNode && !this.visibility_) {
      ...
      console.log('[VideoSource] Adding source video element to page.', `${this.debugPath_}.video_ =`, this.video_)
      const outputVideoContainer = document.getElementById('outputVideoContainer')
      outputVideoContainer.parentNode.insertBefore(this.video_, outputVideoContainer)
    }
  }
  /** @override */
  async getMediaStream() {
    ...
    await this.stream_
    console.log('[VideoSource] Received source video stream.', `${this.debugPath_}.stream_ =`, this.stream_)
    return this.stream_
  }
  /** @override */
  destroy() {
