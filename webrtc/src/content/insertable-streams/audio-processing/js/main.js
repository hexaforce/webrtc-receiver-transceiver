...
try {
  ...
  alert('Your browser does not support insertable audio streams. See the note ' + 'at the bottom of the page.')
}

if (typeof AudioData === 'undefined') {
  alert('Your browser does not support WebCodecs. See the note at the bottom ' + 'of the page.')
}
