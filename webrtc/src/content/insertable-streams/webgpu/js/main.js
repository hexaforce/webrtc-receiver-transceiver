...
if (typeof MediaStreamTrackProcessor === 'undefined' || typeof MediaStreamTrackGenerator === 'undefined') {
  const errorMessage = 'Your browser does not support the MediaStreamTrack ' + 'API for Insertable Streams of Media which was shipped in M94.'
...
async function getMediaStream(src) {
  ...
  await mediaPromise
  console.log('Received source video stream.', sourceStream)
  return sourceStream
}
