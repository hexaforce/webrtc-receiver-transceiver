...
onmessage = ({ data }) => {
  if (data.operation === "encode" || data.operation === "decode") {
    return handleTransform(data.operation, data.readable, data.writable);
  }
  // if (data.operation === 'setCryptoKey') {
  //   if (data.currentCryptoKey !== currentCryptoKey) {
  //     currentKeyIdentifier++
  //   }
  //   currentCryptoKey = data.currentCryptoKey
  //   useCryptoOffset = data.useCryptoOffset
  // }
};
