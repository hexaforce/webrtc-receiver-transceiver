...
async function init(constraints, isGetDisplayMedia) {
  try {
    const stream = isGetDisplayMedia ? await navigator.mediaDevices.getDisplayMedia(constraints) : await navigator.mediaDevices.getUserMedia(constraints)
